...
<ThemeProvider theme={theme}>
    <SectionHeader
        title={<span>We are reimagining renting to help you <span className="text-highlighted">achieve your dreams</span></span>}
        subtitle="Our mission is to help you grow your business, meet and connect with people who share your passions. We help you fulfill your best potential through an engaging lifestyle experience."
    />
</ThemeProvider>
```
...
<ThemeProvider theme={theme}>
    <SectionHeader
        ...
        subtitle="Companies from across the globe have had fantastic experiences using LRE Water. Here’s what they have to say."
        ctaGroup={[(
            <Button color="primary" variant="contained">Submit</Button>
        ), (
            <Button color="primary" variant="outlined">Learn More</Button>
